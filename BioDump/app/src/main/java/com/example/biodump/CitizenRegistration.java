...
public class CitizenRegistration extends AppCompatActivity {
    String[] Dhaka = {"Dhaka","Gazipur","Mymensingh"};
    String[] Sylhet = {"Srimongol","Shunamganj","Hobigonj"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Dhaka")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(CitizenRegistration.this,android.R.layout.simple_spinner_item,list);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent citizenloginemail  = new Intent(CitizenRegistration.this,Homepg.class);
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(CitizenRegistration.this);
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if(task.isSuccessful()){
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(CitizenRegistration.this);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(CitizenRegistration.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
                                                });
